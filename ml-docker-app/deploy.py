...
docker_image_uri = "072440950856.dkr.ecr.us-east-1.amazonaws.com/bankchurnprediction:latest6"
...
model_name = "my-randomforest-model6"
primary_container = {
...
endpoint_config_name = "my-endpoint-config6"
